    ...
    <div className="about-me">
      ...
      <div className="paragraph-container">
        ...
        <p className="paragraph">
          ...
          applications that come to life on the internet. My fascination with
          web development took root back in 2010 when I watched &quot;The Social
        ...
        <p className="paragraph">
          ...
          web programming has introduced a revolutionary library that has
          reshaped the entire web development landscape. I&#39;m incredibly
          grateful for the advent of React, as it has added an unparalleled
          level of elegance to the web development process. Throughout my
          career, I&#39;ve constructed numerous web applications, but React has
          truly elevated my work.
        </p>
        ...
        <p className="paragraph">
          ...
          about the prospects of contributing my skills and passion to future
          projects.
        </p>
      </div>
    </div>
